/*
  ...
  1. Changes
    - Remove unique constraint from user_id in stripe_customers table
    - This allows a user to have multiple Stripe customer records
    - Maintains all other constraints and policies
*/
...
ALTER TABLE IF EXISTS stripe_customers DROP CONSTRAINT IF EXISTS stripe_customers_user_id_key;
